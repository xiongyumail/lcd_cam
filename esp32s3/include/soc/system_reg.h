...
/* SYSTEM_CAN_CLK_EN : R/W ;bitpos:[19] ;default: 1'b0 ; */
/*description: .*/
#define SYSTEM_CAN_CLK_EN    (BIT(19))
#define SYSTEM_CAN_CLK_EN_M  (BIT(19))
#define SYSTEM_CAN_CLK_EN_V  0x1
...
/* SYSTEM_CAN_RST : R/W ;bitpos:[19] ;default: 1'b0 ; */
/*description: .*/
#define SYSTEM_CAN_RST    (BIT(19))
#define SYSTEM_CAN_RST_M  (BIT(19))
#define SYSTEM_CAN_RST_V  0x1
